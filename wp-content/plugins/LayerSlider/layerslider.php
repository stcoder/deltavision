...
/********************************************************/
	...
	function layerslider_enqueue_content_res() {
		...
		wp_enqueue_script('layerslider_js', $GLOBALS['lsPluginPath'].'js/layerslider.kreaturamedia.jquery.js', array('jquery'), '3.5.0' );
		wp_enqueue_script('jquery_easing', $GLOBALS['lsPluginPath'].'js/jquery-easing-1.3.js', array('jquery'), '1.3.0' );
		wp_enqueue_style('layerslider_css', $GLOBALS['lsPluginPath'].'css/layerslider.css', array(), '3.5.0' );
	}
...
/********************************************************/
	...
	function layerslider_enqueue_admin_res() {
		...
		// Global
		wp_enqueue_style('layerslider_global_css', $GLOBALS['lsPluginPath'].'css/global.css', array(), '3.5.0' );
		...
		if(strstr($_SERVER['REQUEST_URI'], 'layerslider')) {
			...
			wp_enqueue_script('layerslider_admin_js', $GLOBALS['lsPluginPath'].'js/admin.js', array('jquery'), '3.5.0' );
			wp_enqueue_style('layerslider_admin_css', $GLOBALS['lsPluginPath'].'css/admin.css', array(), '3.5.0' );
